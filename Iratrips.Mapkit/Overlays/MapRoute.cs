namespace Iratrips.MapKit.Overlays
{
    ...
    /// </summary>
    public class MapRoute : MapOverlay, IRouteFunctions
    {
         ...
         float _lineWidth;
         bool _selectAble;
         MapRouteTravelMode _travelMode;
         MapSpan _bounds;
         MapRouteStep[] _steps;
         double _distance;
         double _travelTime;
        ...
        /// <summary>
        /// Gets/Sets if a route is selectable. If this is <value>false</value> <see cref="MapControl.RouteClickedCommand"/> will not get raised for this route
        /// </summary>
        ...
        /// </summary>
        public MapRouteTravelMode TravelMode
        {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="MapRoute"/>
        /// </summary>
        public MapRoute()
        {
            LineWidth = 2.5f;
        ...
        ///<inheritdoc/>
        void IRouteFunctions.SetSteps(MapRouteStep[] steps)
        {
            Steps = steps;
        }
        ///<inheritdoc/>
