namespace Iratrips.MapKit.Overlays
{
    ...
    public class MKTileUrlOptions 
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="MKTileUrlOptions"/>
        /// </summary>
        ...
        /// </param>
        public MKTileUrlOptions(string tilesUrl, int tileWidth, int tileHeight, int minZoomLevel, int maxZoomLevel)
        {
            TileWidth = tileWidth;
