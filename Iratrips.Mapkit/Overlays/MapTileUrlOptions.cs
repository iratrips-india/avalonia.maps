namespace Iratrips.MapKit.Overlays
{
    ...
    /// Tile Url Options
    /// </summary>
    public class MapTileUrlOptions 
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="MapTileUrlOptions"/>
        /// </summary>
        ...
        /// </param>
        public MapTileUrlOptions(string tilesUrl, int tileWidth, int tileHeight, int minZoomLevel, int maxZoomLevel)
        {
            TileWidth = tileWidth;
